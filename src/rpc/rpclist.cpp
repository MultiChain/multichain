...
/* MCHN END */    
    ...
    { "hidden",             "updatefeedstreams",      &updatefeedstreams,       true,      false,      false },
    { "hidden",             "removefeedstreams",      &removefeedstreams,       true,      false,      false },
    { "hidden",             "addfeedblocks",          &addfeedblocks,           true,      false,      false },
    { "hidden",             "updatefeedblocks",       &updatefeedblocks,        true,      false,      false },
    ...
    { "hidden",             "getdatarefdata",         &getdatarefdata,          true,      false,      false },
    { "hidden",             "datareftobinarycache",   &datareftobinarycache,    true,      false,      false },
