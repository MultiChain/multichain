...
//            "      \"param-name\": \"param-value\"   (strings, required) The key is the parameter name, the value is parameter value\n"
            ...
            "    {\n"
            "      \"for\": \"entity-identifier\"    (string, optional) Asset/stream identifier - one of the following: stream txid, stream reference, stream name.\n"
            "        or\n"
            "      \"for\": entity-identifier(s)   (array, optional) A json array of asset/stream identifiers .\n"    
            "    }\n"
            "4. \"javascript-code\"                (string, required) JavaScript filter code, see help filters for details. Example:\n"
            "                                                         function filtertransaction()\n"
            "                                                         {\n"
            "                                                             var tx=getfiltertransaction();\n"
            "                                                                                          \n"
            "                                                             if (false)\n"
            "                                                                 return \"Transaction failed filter\";\n"
            "                                                         }   \n "
...
//            "      \"param-name\": \"param-value\"   (strings, required) The key is the parameter name, the value is parameter value\n"
            ...
            "      \"for\": entity-identifier(s)   (array, optional) A json array of asset/stream identifiers .\n"    
            "    }\n"
            "5. \"javascript-code\"                (string, required) JavaScript filter code, see help filters for details. Example:\n"
            "                                                         function filtertransaction()\n"
            "                                                         {\n"
            "                                                             var tx=getfiltertransaction();\n"
            "                                                                                          \n"
...
void mc_InitRPCHelpMap18()
{
    mapHelpStrings.insert(std::make_pair("getchunkqueuetotals",
     ...
     mapHelpStrings.insert(std::make_pair("testtxfilter",
            ...
            "      \"for\": entity-identifier(s)   (array, optional) A json array of asset/stream identifiers .\n"    
            "    }\n"
            "2. \"javascript-code\"                (string, required) JavaScript filter code, Example:\n"
            "                                                         function filtertransaction()\n"
            "                                                         {\n"
            "                                                             var tx=getfiltertransaction();\n"
            "                                                                                          \n"
