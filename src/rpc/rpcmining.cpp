...
Value prioritisetransaction(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "Transaction prioritization is not supported in this version of Rk");        
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    throw JSONRPCError(RPC_NOT_SUPPORTED, "getblocktemplate is not supported in this version of Rk");        
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Rk is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Rk is downloading blocks...");
