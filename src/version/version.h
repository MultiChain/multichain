...
#define MULTICHAIN_VERSION_REVISION  4
#define MULTICHAIN_VERSION_STAGE     9
#define MULTICHAIN_VERSION_BUILD     1

#define MULTICHAIN_PROTOCOL_VERSION 10010
...
#define MULTICHAIN_BUILD_DESC "1.0.4"
#define MULTICHAIN_BUILD_DESC_NUMERIC 10004901
