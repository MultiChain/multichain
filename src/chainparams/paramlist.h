...
static const mc_OneMultichainParam MultichainParamArray[] =
{
    ...
    { "mineemptyrounds"                   , "mine-empty-rounds"             ,
                   ...
                   "miningturnover","",
                   "Default for how many rounds of empty blocks will be mined after non-empty block. If set to negative value - mine empty blocks always. Ignored if target-adjust-freq>=0"},                   
