...
static const mc_OneMultichainParam MultichainParamArray[] =
{
    ...
    { "allowfilters"                         , "allow-filters"                         ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE                  , -1,         1,          0,         0, 0.0, 20004, 0, "-mc-allowfilters",
    ...
    { "adminconsensusupgrade"               , "admin-consensus-upgrade"               , 
                   ...
                   "adminconsensusfilter","",
                   "<admin-consensus-upgrade>*<active admins> needed to upgrade the chain."},
    { "adminconsensusfilter"               , "admin-consensus-filter"               , 
                   MC_PRM_UINT32  | MC_PRM_USER | MC_PRM_CLONE | MC_PRM_DECIMAL , -1,    500000,          0,   1000000, 0.0, 20004, 0, "-mc-adminconsensusfilter",
                   "adminconsensusadmin","",
                   "<admin-consensus-filter>*<active admins> needed to approve filter in the chain."},
