...
static const mc_OneMultichainParam MultichainParamArray[] =
{
    ...
    { "lockadminminerounds"                       , "lock-admin-mine-rounds"                       , 
                   MC_PRM_UINT32  | MC_PRM_USER | MC_PRM_CLONE | MC_PRM_NOHASH  , -1,         10,         0,     10000, 0.0, 10001, 0, "-mc-setupfirstblocks",
                   "miningrequirespeers","Defaults to runtime parameters",
                   "Default value for allowed depth blockchain reorganization since last change in governance model."},    
    ...
    { "mineemptyblocks"                   , "mine-empty-blocks"             ,
                   MC_PRM_BOOLEAN | MC_PRM_USER | MC_PRM_CLONE | MC_PRM_NOHASH  , -1,         1,          0,         0, 0.0, 10007, 0, "-mc-mineemptyblocks",
                   "miningturnover","",
                   "Default for whether nodes mine blocks if mempool is empty. Ignored if target-adjust-freq>=0"},                   
    { "miningturnover"                    , "mining-turnover"             ,
                   ...
                   "initialblockreward","",
                   "Default for miner turnover rate."},                   
/*                   
...
*/                   
    ...
    { "maxstdtxsize"                 , "max-std-tx-size"                 , 
                   MC_PRM_UINT32  | MC_PRM_USER | MC_PRM_CLONE                  , -1,   4194304,       1024,  10000000, 0.0, 10001, 0, "-mc-maxstdtxsize",
    ...
    { "maxstdopreturnsize"                  , "max-std-op-return-size"                  , 
                   MC_PRM_UINT32  | MC_PRM_USER | MC_PRM_CLONE                  , -1,   2097152,          0,   8388608, 0.0, 10001, 0, "-mc-maxstdopreturnsize",
                   "maxstdopdropscount","",
