...
/** Maximal number of headers to fetch ahead of actually downloaded blocks */
static const int MAX_AHEAD_HEADERS = 10000;
...
/** Flush block index cache if needed. */
